...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://artem-stackbit.ngrok.io/pull/6059fcfd5638fecdb2062374
...
To start editing your site, you can use the Sanity interface at https://nervous-thyme-9fcfd.sanity.studio/.
...
Generated at `2021-03-23T14:37:01.748Z` by Stackbit version `0.3.50-staging.0`.